...
public final class ServerFlag {
    ...
    // Server Behavior
    public static final int DEFAULT_PORT = intProperty("minestom.default-port", 25565);
    public static final String DEFAULT_ADDRESS = stringProperty("minestom.default-address", "0.0.0.0");
