...
public final class TickUtils {
    ...
    /**
     * Creates a number of ticks from a given duration, based on {@link ServerFlag#SERVER_TICKS_MS}.
     *
    ...
    public static int fromDuration(@NotNull Duration duration) {
        return TickUtils.fromDuration(duration, ServerFlag.SERVER_TICKS_MS);
    }
